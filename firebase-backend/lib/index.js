...
exports.health = exports.getWeather = exports.updateTrip = exports.createTrip = exports.getTrips = exports.getDashboardStats = exports.getPOIs = exports.getRoutes = void 0;
 ...
 */
exports.getPOIs = functions.https.onRequest(async (req, res) => {
    corsHandler(req, res, async () => {
        try {
            res.set('Cache-Control', 'public, max-age=31536000'); // 1 year
            res.set('Content-Type', 'application/json');
    ...
    corsHandler(req, res, async () => {
        try {
            ...
            const stats = {
                ...
                pois: {
                    visited: trips.reduce((sum, trip) => sum + (trip.poisVisited?.length || 0), 0)
                }
            };
            return res.status(200).json({
                success: true,
 ...
 * Update a trip
 */
exports.updateTrip = functions.https.onRequest(async (req, res) => {
    corsHandler(req, res, async () => {
        try {
            // 🔒 SECURE: Verify token and get userId
            const userId = await verifyAuth(req, res);
